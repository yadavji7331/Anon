...
from AnonX import BOT_USERNAME, app
from AnonX.core.decorator import asyncify, capture_err
from AnonX.core.decorator.ratelimiter import ratelimiter
from AnonX.helper import fetch, use_chat_lang
from AnonX.vars import COMMAND_HANDLER, SUDO, SUPPORT_CHAT
from utils import temp

LOGGER = getLogger("AnonX")
...
def welcomepic(pic, user, chat, id, strings):
    background = Image.open("AnonX/assets/bg.png")  # <- Background Image (Should be PNG)
    ...
    font = ImageFont.truetype(
        "AnonX/assets/Calistoga-Regular.ttf", 37
    ...
    ImageDraw.Draw(background).text(
        ...
        font=ImageFont.truetype("AnonX/assets/Calistoga-Regular.ttf", 28),
        size=20,
        align="right",
    )
    background.paste(
...
async def member_has_joined(c: app, member: ChatMemberUpdated, strings):
    ...
    if user.id in SUDO:
        ...
        try:
            ...
            pic = "AnonX/assets/profilepic.png"
        try:
