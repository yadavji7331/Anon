...
HELP_BACK = [
     [
           InlineKeyboardButton(text="Qᴜᴇꜱᴛɪᴏɴ ᴛʜᴀᴛ ᴄʜᴀᴛɢᴘᴛ ᴄᴀɴ ꜱᴏʟᴠᴇ ", url=f"https://t.me/Iam_daxx"),
...
@DAXXA.on_message(filters.command("bard"))
...
if SOURCE != s:
    print("So sad, you have changed source, change it back to ` https://github.com//Chatgpt-bot `  else I won't work")
    sys.exit(1)  
