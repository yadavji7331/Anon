...
def add_corners(im):
    ...
    ImageDraw.Draw(mask).rectangle((9, 9) + bigsize, fill=255)
...
async def gen_thumb(videoid, user_id):
    ...
    try:
        ...
        bg = Image.open(f"AnonX/assets/mrdaxx.png")
        ...
        logo.thumbnail((1280, 720), Image.ANTIALIAS)
